...
export type InterceptorRequestErrorInputFunction<RootState, ConfigType extends NetClientConfigWithID, ResponseType, ErrorType> = (
  error: ErrorType,
...
export type RequestInterceptorListType<RootState, ConfigType extends NetClientConfigWithID, ResponseType, ErrorType> = (
  serviceClient: ServiceClientInterface<RootState, ConfigType, ResponseType, ErrorType>,
) => RequestInterceptorType<ConfigType, ErrorType>[]
